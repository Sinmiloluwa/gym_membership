<template>
    ...
    <div
            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                ...
                <p class="mt-4 text-lg text-gray-300">
                  Welcome to DrDre Fitness, where your health and fitness matters a lot
                  Staying fit means you are a step closer to complete health
                </p>
              </div>
            </div>
          </div>
      ...
      <section class="pb-20 bg-black -mt-24">
              ...
              >
                ...
                <blockquote class="relative p-8 mb-4">
                  ...
                  <p class="text-md font-light mt-2 text-white">
                   Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec orci leo, 
                   malesuada blandit odio scelerisque, viverra posuere tellus. 
      ...
      <section class="relative py-20">
        ...
        <div class="container mx-auto px-4">
            <p class="text-center font-semibold text-4xl mb-5" style="padding-bottom:20px">Meet Our Instructors</p>
          <div class="items-center flex flex-wrap">
      ...
      <section class="pb-20 relative block bg-black">
        ...
        >
          ...
          >
            <polygon
              class="text-indigo-900 fill-current"
              points="2560 0 2560 100 0 100"
            ></polygon>
          </svg>
        </div>
        <div class="container mx-auto px-4 lg:pt-24 lg:pb-64">
          ...
          <div class="flex flex-wrap mt-12 justify-center">
            <div class="w-full lg:w-3/12 px-4 text-center">
              ...
              <p class="mt-2 mb-4 text-gray-500">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                 Donec orci leo, malesuada blandit odio scelerisque, viverra posuere tellus
              </p>
            </div>
            <div class="w-full lg:w-3/12 px-4 text-center">
              <div
            ...
            <div class="w-full lg:w-3/12 px-4 text-center">
              ...
              <h5 class="text-xl mt-5 font-semibold text-white">Conducive Environment</h5>
              <p class="mt-2 mb-4 text-gray-500">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                 Donec orci leo, malesuada blandit odio scelerisque, viverra posuere tellus
              </p>
      ...
      <section class="relative block py-24 lg:pt-0 bg-black">
        <div class="container mx-auto px-4">
          <div class="flex flex-wrap justify-center lg:-mt-64 -mt-48">
            <div class="w-full lg:w-6/12 px-4">
              <div
                class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-indigo-700"
              >
                <div class="flex-auto p-5 lg:p-10">
                  <h4 class="text-2xl font-semibold text-white">Let us work together</h4>
